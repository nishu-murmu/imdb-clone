...
export const FacebookIcon = ({ className }: IconsProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
...
export const InstagramIcon = ({ className }: IconsProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
...
export const TwitterIcon = ({ className }: IconsProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
...
export const TwitchIcon = ({ className }: IconsProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
...
export const YoutubeIcon = ({ className }: IconsProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
...
export const TiktokIcon = ({ width, height, className }: IconsProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const StarIcon = (props: IconsProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="yellow"
...
export const LinkIcon = () => {
  return (
    <svg
      ...
      height="16"
      fill="currentColor"
      className="mt-0.5 bi bi-box-arrow-up-right"
      viewBox="0 0 16 16"
    >
      <path
        fillRule="evenodd"
...
export const CheckMarkIcon = ({ width, height, fillColor }: IconsProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const BookMarkCheckFillIcon = (props: IconsProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={props.width}
...
export const WarningIcon = ({ width, height, fillColor }: IconsProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
